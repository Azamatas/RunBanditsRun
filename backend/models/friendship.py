...
class Friendship(Base):
    ...
    status: Mapped[FriendshipStatus] = mapped_column(Enum(FriendshipStatus, name="friendship_status", values_callable=lambda obj: [e.value for e in obj]), default=FriendshipStatus.PENDING)
