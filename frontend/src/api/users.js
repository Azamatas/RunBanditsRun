...
export const unfollowUser = (id) => client.delete(`/users/${id}/unfollow`).then((r) => r.data);
...
export const getSentRequests = () => client.get("/users/me/sent-requests").then((r) => r.data);
